      ...
      <div class="bg-white border border-primary/10 rounded-xl p-8 shadow-xl mb-8">
        ...
        <ul class="space-y-4 max-w-2xl mx-auto">
          <li class="flex items-start gap-3">
            ...
            <p class="text-primary/90">Histoires d'ingrédients mexicains introuvables au Panier</p>
          </li>
          <li class="flex items-start gap-3">
            <span class="text-2xl">✈️</span>
            <p class="text-primary/90">Carnets de voyage culinaire entre Queretaro et la Bonne Mère</p>
          </li>
          <li class="flex items-start gap-3">
            <span class="text-2xl">🥘</span>
            <p class="text-primary/90">Conseils pour préparer votre garniture de pozole parfaite (radis, origan, citron vert)</p>
          </li>
          <li class="flex items-start gap-3">
            <span class="text-2xl">❤️</span>
            <p class="text-primary/90">Billets d'humeur sur la vie de couple mixte en cuisine</p>
          </li>
        </ul>
      </div>
